...
[![pub package](https://img.shields.io/pub/v/facebook_flutter_sdk.svg)](https://pub.dev/packages/facebook_flutter_sdk)
[![License: Apache 2.0](https://img.shields.io/badge/License-Apache%202%2E0-lightgrey.svg)](https://github.com/oddbit/flutter_facebook_flutter_sdk/blob/main/LICENSE)
[![pub likes](https://img.shields.io/pub/likes/facebook_flutter_sdk)](https://pub.dev/packages/facebook_flutter_sdk/score)
[![pub points](https://img.shields.io/pub/points/facebook_flutter_sdk)](https://pub.dev/packages/facebook_flutter_sdk/score)
...
> This plugin is a fork of [flutter_facebook_app_events](https://pub.dev/packages/facebook_app_events). 
> The original plugin wasn't ok to provide complete support for AEM and some other required features to creates working Facebook Ads campaigns. 
> This plugin is a continuation of the original one, with the same API and support for all features of the latest Facebook SDKs with a focus on App Events and AEM.
...
You don't need an MMP to track purchases. 
MMP are good when you run multiple campaigns on multiple channels, but if you run only Facebook Ads, you can log purchase events directly to Facebook App Events and use them for ad optimization and reporting. (will save you time and money)

If you are using [RevenueCat](https://www.revenuecat.com/) for in-app purchases, you can log purchase events to Facebook App Events like this 
...
<details>
<summary>🔔 Facebook Event Manager "Please Upgrade SDK" Warning</summary>
...
- [GitHub Issue #402](https://github.com/oddbit/flutter_facebook_flutter_sdk/issues/402)
...
- Swift Package Manager: the plugin includes a Swift package manifest at [ios/facebook_flutter_sdk/Package.swift](ios/facebook_flutter_sdk/Package.swift). Facebook's official iOS SDK also documents SPM support (see [Swift Package Manager](https://github.com/facebook/facebook-ios-sdk#swift-package-manager)).

## ℹ️ About Facebook App Events
...
[report an issue](https://github.com/oddbit/flutter_facebook_flutter_sdk/issues)
